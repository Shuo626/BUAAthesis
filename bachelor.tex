...
\include{data/chapter2-tech-base}
\include{data/chapter3-demand-analysis}
\include{data/chapter4-system-design}
\include{data/chapter5-system-implement}
\include{data/chapter6-expr}
